...
public class PostsFoundRepository {

    private static PostsFoundRepository instance ;
    ...
    private static FoundFragment mContext ;
    ...
    public static PostsFoundRepository getInstance(FoundFragment context){
        mContext = context ;
        if (instance == null){
            instance = new PostsFoundRepository();
        }
