...
public class ReadMoreOption {
        ...
        textView.post(new Runnable() {
            ...
            public void run() {
                ...
                SpannableStringBuilder spannableStringBuilder =
                        new SpannableStringBuilder(text.subSequence(0, textLengthNew))
                        .append("...")
                        .append(moreLabel);
    ...
    public static class Builder {
        ...
        private int moreLabelColor = Color.parseColor("#f69314");
        private int lessLabelColor =  Color.parseColor("#f69314");
